...
echo -e "- Red Main: ${GREEN}192.168.1.254${NC} (enp0s8)"
echo -e "- Red Internal: ${GREEN}192.168.2.254${NC} (enp0s9)"
...
echo -e "Haciendo el script executable..."
chmod +x /home/Chadry/esi/gyar/trabajo/baremetal/bootstrap_jumpstart.sh
